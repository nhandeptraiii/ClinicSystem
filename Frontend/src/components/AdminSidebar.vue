...
const menuItems = [
  ...
  { label: 'Tiếp đón & Hàng chờ', to: 'visits', icon: ClipboardDocumentListIcon, roles: ['RECEPTIONIST', 'ADMIN'] },
  ...
  { label: 'Phòng khám', to: 'clinic-rooms', icon: BuildingOffice2Icon, roles: ['ADMIN'] },
